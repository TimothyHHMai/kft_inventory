...
def miscellaneous_api(request, id=None):
    ...
    if request.method == 'GET':
        ...
        allowed_sort_columns = {'miscellaneous_name', 'current_individual_stock', 'current_box_stock', 'quantity_box'}
        allowed_sort_orders = {'asc', 'desc'}
        ...
        if id:
            ...
            if sortBy in allowed_sort_columns and sortOrder in allowed_sort_orders:
                ...
                cursor.execute("CALL get_all_miscellaneous()")  # fallback if invalid params
